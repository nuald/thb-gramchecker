...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\grammarchecker on
     Windows, /home/user/dev/grammarchecker on Linux) in a file named
     grammarchecker@codedgers.com and copy that file to
